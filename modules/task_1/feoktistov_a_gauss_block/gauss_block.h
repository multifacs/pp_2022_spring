...
#ifndef MODULES_TASK_1_FEOKTISTOV_A_GAUSS_BLOCK_GAUSS_BLOCK_H_
#define MODULES_TASK_1_FEOKTISTOV_A_GAUSS_BLOCK_GAUSS_BLOCK_H_
#include <vector>
#include <string>
...
#endif  // MODULES_TASK_1_FEOKTISTOV_A_GAUSS_BLOCK_GAUSS_BLOCK_H_
