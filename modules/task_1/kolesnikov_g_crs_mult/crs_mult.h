...
#ifndef MODULES_TASK_1_KOLESNIKOV_G_CRS_MULT_CRS_MULT_H_
#define MODULES_TASK_1_KOLESNIKOV_G_CRS_MULT_CRS_MULT_H_
...
std::vector<std::vector<double>> generateMatrix(int cols, int rows,
    double density);
#endif  // MODULES_TASK_1_KOLESNIKOV_G_CRS_MULT_CRS_MULT_H_
