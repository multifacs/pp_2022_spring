...
void Strassen(int n, const matrix& A, const matrix& B, matrix* C) {
  matrix A11 = std::vector<vec>(n, vec(n, 0)),
         A12 = std::vector<vec>(n, vec(n, 0)),
         A21 = std::vector<vec>(n, vec(n, 0)),
         A22 = std::vector<vec>(n, vec(n, 0));
  matrix B11 = std::vector<vec>(n, vec(n, 0)),
         B12 = std::vector<vec>(n, vec(n, 0)),
         B21 = std::vector<vec>(n, vec(n, 0)),
         B22 = std::vector<vec>(n, vec(n, 0));
  matrix C11 = std::vector<vec>(n, vec(n, 0)),
         C12 = std::vector<vec>(n, vec(n, 0)),
         C21 = std::vector<vec>(n, vec(n, 0)),
         C22 = std::vector<vec>(n, vec(n, 0));
  matrix M1 = std::vector<vec>(n, vec(n, 0)),
         M2 = std::vector<vec>(n, vec(n, 0)),
         M3 = std::vector<vec>(n, vec(n, 0)),
         M4 = std::vector<vec>(n, vec(n, 0)),
         M5 = std::vector<vec>(n, vec(n, 0)),
         M6 = std::vector<vec>(n, vec(n, 0)),
         M7 = std::vector<vec>(n, vec(n, 0));
  matrix AA = std::vector<vec>(n, vec(n, 0)),
         BB = std::vector<vec>(n, vec(n, 0));
