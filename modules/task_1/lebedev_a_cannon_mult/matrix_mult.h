...
#ifndef MODULES_TASK_1_LEBEDEV_A_CANNON_MULT_MATRIX_MULT_H_
#define MODULES_TASK_1_LEBEDEV_A_CANNON_MULT_MATRIX_MULT_H_
#include <random>
#include <vector>
...
#endif  // MODULES_TASK_1_LEBEDEV_A_CANNON_MULT_MATRIX_MULT_H_
