// Copyright 2022 Shabunin Vladislav
#ifndef MODULES_TASK_1_SHABUNIN_CSR_MULT_DOUBLE_CSR_MULT_DOUBLE_H_
#define MODULES_TASK_1_SHABUNIN_CSR_MULT_DOUBLE_CSR_MULT_DOUBLE_H_
...
class CSRMatrix {
 public:
  ...
  explicit CSRMatrix(UIntType height, UIntType width) : num_cols_(width), counts_(height + 1, 0) {
  }
...
#endif  // MODULES_TASK_1_SHABUNIN_CSR_MULT_DOUBLE_CSR_MULT_DOUBLE_H_
