...
TEST(burkukov_dijkstra_omp, create) {
...
TEST(burkukov_dijkstra_omp, simple_path_1v) {
...
TEST(burkukov_dijkstra_omp, simple_path_5000v) {
  int size = 5000;
...
TEST(burkukov_dijkstra_omp, tree) {
    int size = 5000;
    std::vector<std::vector<int>> a(size, std::vector<int>(size, 0));
    for (int i = 0; i < size; i++)
...
TEST(burkukov_dijkstra_omp, tree_simp) {
