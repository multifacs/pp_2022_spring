...
TEST(Gaussian_Filter_, Test_Random_Matrix_Size_25x25) {
    int rows = 25;
    int cols = 25;
...
TEST(Gaussian_Filter_, Test_Random_Matrix_Size_250x250) {
    int rows = 250;
    int cols = 250;
    std::vector<double> matrix = createRandomMatrix(rows, cols);
...
TEST(Gaussian_Filter_, Test_Random_Matrix_Size_500x500) {
    int rows = 500;
    int cols = 500;
    std::vector<double> matrix = createRandomMatrix(rows, cols);
