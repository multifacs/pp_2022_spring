...
TEST(Integration_Monte_Carlo_OMP, n_is_0) {
  double low = 0.0, top = 10.0;
  ASSERT_ANY_THROW(getIntegralOMP(-1, {low}, {top}, f1));
}

TEST(Integration_Monte_Carlo_OMP, dimension_is_1) {
  double low = 0.0, top = 3.0;
  clock_t start_seq = clock();
  double res_seq = getIntegralSequential(200000, {low}, {top}, f1);
  clock_t end_seq = clock();
  double seconds_seq = static_cast<double>(end_seq - start_seq) / CLOCKS_PER_SEC;
  printf("Sequence algorithm: %f seconds\n", seconds_seq);

  clock_t start_omp = clock();
  double res_omp = getIntegralOMP(200000, {low}, {top}, f1);
  clock_t end_omp = clock();
  double seconds_omp = static_cast<double>(end_omp - start_omp) / CLOCKS_PER_SEC;
  printf("Parallel algorithm: %f seconds\n", seconds_omp);
  printf("boost RATE: %f \n", seconds_seq/seconds_omp);
  ASSERT_NEAR(res_seq, res_omp, 0.2);
}

TEST(Integration_Monte_Carlo_OMP, dimension_is_2) {
  std::vector<double> low = {-1.0, 1.0};
  std::vector<double> top = {0.0, 2.0};
  clock_t start_seq = clock();
  double res_seq = getIntegralSequential(200000, low, top, f2);
  clock_t end_seq = clock();
  double seconds_seq = static_cast<double>(end_seq - start_seq) / CLOCKS_PER_SEC;
  printf("Sequence algorithm: %f seconds\n", seconds_seq);

  clock_t start_omp = clock();
  double res_omp = getIntegralOMP(200000, low, top, f2);
  clock_t end_omp = clock();
  double seconds_omp =
      static_cast<double>(end_omp - start_omp) / CLOCKS_PER_SEC;
  printf("Parallel algorithm: %f seconds\n", seconds_omp);
  printf("boost RATE: %f \n", seconds_seq / seconds_omp);
...
TEST(Integration_Monte_Carlo_OMP, mdimension_is_3_v1) {
  std::vector<double> low = {-4.0, 0.0, 1.5};
  std::vector<double> top = {-3.0, 5.0, 3.0};
  clock_t start_seq = clock();
  double res_seq = getIntegralSequential(200000, low, top, f3);
  clock_t end_seq = clock();
  double seconds_seq =
  ...
  clock_t start_omp = clock();
  double res_omp = getIntegralOMP(200000, low, top, f3);
  clock_t end_omp = clock();
  double seconds_omp =
      static_cast<double>(end_omp - start_omp) / CLOCKS_PER_SEC;
  printf("Parallel algorithm: %f seconds\n", seconds_omp);
...
TEST(Integration_Monte_Carlo_OMP, dimension_is_3_v2) {
  ...
  std::vector<double> top = {1.0, 2.0, 3.0};
  clock_t start_seq = clock();
  double res_seq = getIntegralSequential(200000, low, top, f4);
  clock_t end_seq = clock();
  double seconds_seq =
      static_cast<double>(end_seq - start_seq) / CLOCKS_PER_SEC;
  printf("Sequence algorithm: %f seconds\n", seconds_seq);
  ...
  clock_t start_omp = clock();
  double res_omp = getIntegralOMP(200000, low, top, f4);
  clock_t end_omp = clock();
  double seconds_omp =
      static_cast<double>(end_omp - start_omp) / CLOCKS_PER_SEC;
  printf("Parallel algorithm: %f seconds\n", seconds_omp);
