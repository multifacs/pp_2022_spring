...
#ifndef MODULES_TASK_2_KRUGLOV_CG_METHOD_PARALLEL_H_
#define MODULES_TASK_2_KRUGLOV_CG_METHOD_PARALLEL_H_
#include <vector>
...
#endif  // MODULES_TASK_2_KRUGLOV_CG_METHOD_PARALLEL_H_
