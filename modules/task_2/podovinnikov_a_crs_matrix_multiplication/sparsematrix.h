...
#ifndef MODULES_TASK_2_PODOVINNIKOV_A_CRS_MATRIX_MULTIPLICATION_SPARSEMATRIX_H_
#define MODULES_TASK_2_PODOVINNIKOV_A_CRS_MATRIX_MULTIPLICATION_SPARSEMATRIX_H_
...
std::vector<std::complex<double>>
   stupidDenseMultiplication(const std::vector<std::complex<double>> & a,
                             ...
                             const int size);
#endif  // MODULES_TASK_2_PODOVINNIKOV_A_CRS_MATRIX_MULTIPLICATION_SPARSEMATRIX_H_
