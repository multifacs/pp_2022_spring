...
#ifndef MODULES_TASK_2_PURTOVA_K_SHELL_SORT_BATCHER_MERGE_SHELL_SORT_H_
#define MODULES_TASK_2_PURTOVA_K_SHELL_SORT_BATCHER_MERGE_SHELL_SORT_H_

#include <vector>

void Shell(const std::vector<int>& A, int n);
