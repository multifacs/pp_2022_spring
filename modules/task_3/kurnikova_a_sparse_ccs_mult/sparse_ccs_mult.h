...
#ifndef MODULES_TASK_3_KURNIKOVA_A_SPARSE_CCS_MULT_SPARSE_CCS_MULT_H_
#define MODULES_TASK_3_KURNIKOVA_A_SPARSE_CCS_MULT_SPARSE_CCS_MULT_H_
#include <vector>
...
#endif  // MODULES_TASK_3_KURNIKOVA_A_SPARSE_CCS_MULT_SPARSE_CCS_MULT_H_
